...
export const Formats: FormatList = [
	...
	{
		section: "Randomlocke en Comunidad",
		column: 2,
	},
	{
		name: "[Gen 4] Platino Randomlocke",
		desc: `Modo de juego para combates online del randomlocke en comunidad`,
		threads: [
			`&bullet; <a href="https://discord.gg/XXhEXzFgu7">DISCORD</a>`,
		],

		mod: 'gen4',
		ruleset: ['-Nonexistent', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause', 'Sleep Clause Mod', 'Evasion Moves Clause', 'Min Level = 50', 'Max Level = 50'],
	},
